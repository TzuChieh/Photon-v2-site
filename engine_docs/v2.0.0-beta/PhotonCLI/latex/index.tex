...
\Hypertarget{index_md__r_e_a_d_m_e}%
 Photon-\/v2 comes with an application called {\ttfamily Photon\+CLI}, which is a command-\/line interface of the render engine. Command-\/line interface can come in handy if you are batch rendering or using it on a remote server. It also, in theory, offers slightly better performance in terms of render time. This is a documentation of available options and some examples. Check out {\ttfamily Photon\+Studio} if you are more interested in using a GUI.\hypertarget{index_autotoc_md1}{}\doxysection{\texorpdfstring{Available Options}{Available Options}}\label{index_autotoc_md1}
\tabulinesep=1mm
...
\begin{DoxyCode}{0}
\DoxyCodeLine{PhotonCLI\ -\/s\ "{}./ocean.p2"{}\ -\/o\ "{}./my\_image.jpg"{}\ -\/t\ 4}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{PhotonCLI\ -\/s\ "{}./gif\_animation/pose*.p2"{}\ -\/-\/series\ -\/-\/start\ "{}1"{}\ -\/-\/finish\ "{}3"{}\ -\/o\ "{}./gif\_images/"{}\ -\/t\ 4}
