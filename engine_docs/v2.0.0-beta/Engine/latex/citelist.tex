...
\item[\label{citelist_CITEREF_Dammertz:2008:Shallow}%
\Hypertarget{citelist_CITEREF_Dammertz:2008:Shallow}%
\mbox{[}5\mbox{]}]\hfill \\
Holger Dammertz, Johannes Hanika, and Alexander Keller. Shallow bounding volume hierarchies for fast SIMD ray tracing of incoherent rays. {\itshape Computer Graphics Forum (Proceedings of Eurographics)}, 27(2)\+:1225--1233, 2008. 
...
\item[\label{citelist_CITEREF_Fuetterling:2015:Efficient}%
\Hypertarget{citelist_CITEREF_Fuetterling:2015:Efficient}%
\mbox{[}7\mbox{]}]\hfill \\
Valentin Fuetterling, Carsten Lojewski, Franz-\/\+Josef Pfreundt, and Achim Ebert. Efficient ray tracing kernels for modern CPU architectures. {\itshape Journal of Computer Graphics Techniques (JCGT)}, 4\+:90--111, December.
