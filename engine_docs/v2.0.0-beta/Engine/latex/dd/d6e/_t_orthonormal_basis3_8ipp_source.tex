...
\DoxyCodeLine{00063\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::TOrthonormalBasis3}}(}
...
\DoxyCodeLine{00078\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::worldToLocal}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ worldVec)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00086\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::localToWorld}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ localVec)\textcolor{keyword}{\ const}}
\DoxyCodeLine{00087\ \textcolor{keyword}{}\{}
\DoxyCodeLine{00088\ \ \ \ \ \textcolor{keywordflow}{return}\ m\_xAxis.mul(localVec.\mbox{\hyperlink{classph_1_1math_1_1_t_vector3_a8d0eb557cecca2a3e07326c409b2c16b}{x}}()).add(}
...
\DoxyCodeLine{00094\ \textcolor{keyword}{inline}\ T\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::cosPhi}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ unitVec)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00111\ \textcolor{keyword}{inline}\ T\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::sinPhi}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ unitVec)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00128\ \textcolor{keyword}{inline}\ T\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::tanPhi}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ unitVec)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00155\ \textcolor{keyword}{inline}\ T\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::cos2Phi}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ unitVec)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00161\ \textcolor{keyword}{inline}\ T\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::sin2Phi}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ unitVec)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00167\ \textcolor{keyword}{inline}\ T\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::tan2Phi}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ unitVec)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00186\ \textcolor{keyword}{inline}\ T\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::cosTheta}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ unitVec)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00192\ \textcolor{keyword}{inline}\ T\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::sinTheta}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ unitVec)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00198\ \textcolor{keyword}{inline}\ T\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::tanTheta}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ unitVec)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00224\ \textcolor{keyword}{inline}\ T\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::absCosTheta}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ unitVec)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00230\ \textcolor{keyword}{inline}\ T\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::absSinTheta}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ unitVec)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00236\ \textcolor{keyword}{inline}\ T\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::cos2Theta}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ unitVec)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00242\ \textcolor{keyword}{inline}\ T\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::sin2Theta}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ unitVec)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00248\ \textcolor{keyword}{inline}\ T\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::tan2Theta}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ unitVec)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00267\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>}}\&\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::renormalize}}()}
\DoxyCodeLine{00268\ \{}
...
\DoxyCodeLine{00277\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>}}\&\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::renormalizeXAxis}}()}
\DoxyCodeLine{00278\ \{}
...
\DoxyCodeLine{00285\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>}}\&\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::renormalizeYAxis}}()}
\DoxyCodeLine{00286\ \{}
...
\DoxyCodeLine{00293\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>}}\&\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::renormalizeZAxis}}()}
\DoxyCodeLine{00294\ \{}
...
\DoxyCodeLine{00301\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>}}\&\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::setXAxis}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ axis)}
\DoxyCodeLine{00302\ \{}
...
\DoxyCodeLine{00309\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>}}\&\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::setYAxis}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ axis)}
\DoxyCodeLine{00310\ \{}
...
\DoxyCodeLine{00317\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>}}\&\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::setZAxis}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\&\ axis)}
\DoxyCodeLine{00318\ \{}
...
\DoxyCodeLine{00325\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>}}\&\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::set}}(}
...
\DoxyCodeLine{00338\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::getXAxis}}()\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00344\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::getYAxis}}()\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00350\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1math_1_1_t_vector3}{TVector3<T>}}\ \mbox{\hyperlink{classph_1_1math_1_1_t_orthonormal_basis3}{TOrthonormalBasis3<T>::getZAxis}}()\textcolor{keyword}{\ const}}
