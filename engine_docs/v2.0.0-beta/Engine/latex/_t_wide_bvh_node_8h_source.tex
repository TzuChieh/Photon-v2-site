...
\DoxyCodeLine{00046\ }
\DoxyCodeLine{00054\ \ \ \ \ std::size\_t\ \mbox{\hyperlink{classph_1_1math_1_1_t_wide_bvh_node_a0a56e35bb0dc6f5f7d10f9fdc321fa63}{getSplitAxis}}(std::size\_t\ childIdx)\ \textcolor{keyword}{const};}
\DoxyCodeLine{00055\ \ \ \ \ }
\DoxyCodeLine{00056\ \ \ \ \ std::size\_t\ \mbox{\hyperlink{classph_1_1math_1_1_t_wide_bvh_node_a7293167d3649588e09ed8894286eac06}{getItemOffset}}(std::size\_t\ childIdx)\ \textcolor{keyword}{const};}
\DoxyCodeLine{00057\ \ \ \ \ std::size\_t\ \mbox{\hyperlink{classph_1_1math_1_1_t_wide_bvh_node_a2035a757d76349f1efad0ac5e53782d7}{numItems}}(std::size\_t\ childIdx)\ \textcolor{keyword}{const};}
\DoxyCodeLine{00058\ }
\DoxyCodeLine{00059\ \ \ \ \ \mbox{\hyperlink{classph_1_1math_1_1_t_wide_bvh_node}{TWideBvhNode}}\&\ \mbox{\hyperlink{classph_1_1math_1_1_t_wide_bvh_node_adb14ec0b6257976793c35a0d2c88563e}{setInternal}}(}
\DoxyCodeLine{00060\ \ \ \ \ \ \ \ \ std::size\_t\ childIdx,}
\DoxyCodeLine{00061\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_a_a_b_b3_d}{AABB3D}}\&\ childAABB,}
\DoxyCodeLine{00062\ \ \ \ \ \ \ \ \ std::size\_t\ childOffset,}
\DoxyCodeLine{00063\ \ \ \ \ \ \ \ \ std::size\_t\ splitAxis);}
\DoxyCodeLine{00064\ }
\DoxyCodeLine{00065\ \ \ \ \ \mbox{\hyperlink{classph_1_1math_1_1_t_wide_bvh_node}{TWideBvhNode}}\&\ \mbox{\hyperlink{classph_1_1math_1_1_t_wide_bvh_node_ab8ea049aa82d70bb438bc8c667b0be70}{setLeaf}}(}
\DoxyCodeLine{00066\ \ \ \ \ \ \ \ \ std::size\_t\ childIdx,}
\DoxyCodeLine{00067\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_a_a_b_b3_d}{AABB3D}}\&\ childAABB,}
\DoxyCodeLine{00068\ \ \ \ \ \ \ \ \ std::size\_t\ itemOffset,}
\DoxyCodeLine{00069\ \ \ \ \ \ \ \ \ std::size\_t\ \mbox{\hyperlink{classph_1_1math_1_1_t_wide_bvh_node_a2035a757d76349f1efad0ac5e53782d7}{numItems}});}
\DoxyCodeLine{00070\ }
\DoxyCodeLine{00071\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00072\ \ \ \ \ std::array<AABB3D,\ N>\ m\_aabbs;}
\DoxyCodeLine{00073\ }
\DoxyCodeLine{00080\ \ \ \ \ std::array<Index,\ N>\ m\_offsets;}
\DoxyCodeLine{00081\ }
\DoxyCodeLine{00097\ \ \ \ \ std::array<uint8,\ N>\ m\_numItemsAndFlags;}
\DoxyCodeLine{00098\ \};}
\DoxyCodeLine{00099\ }
\DoxyCodeLine{00100\ \}\textcolor{comment}{//\ end\ namespace\ ph::math}}
\DoxyCodeLine{00101\ }
\DoxyCodeLine{00102\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{_t_wide_bvh_node_8ipp}{Math/Algorithm/BVH/TWideBvhNode.ipp}}"{}}}
