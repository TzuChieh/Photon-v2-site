...
\DoxyCodeLine{00165\ \ \ \ \ \ \ \ \ \ \ \ \ positions,\ uvs,\ \&dPdU,\ \&dPdV))}
\DoxyCodeLine{00166\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00167\ \ \ \ \ \ \ \ \ \ \ \ \ dPdU.\mbox{\hyperlink{classph_1_1math_1_1_t_vector_n_base_a66bef10def6b7cfc11adea52b28094e0}{set}}(0);\ dPdV.\mbox{\hyperlink{classph_1_1math_1_1_t_vector_n_base_a66bef10def6b7cfc11adea52b28094e0}{set}}(0);}
\DoxyCodeLine{00168\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00169\ }
\DoxyCodeLine{00170\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(hasShadingNormal\ \&\&\ !Triangle::calcSurfaceParamDerivatives(}
\DoxyCodeLine{00171\ \ \ \ \ \ \ \ \ \ \ \ \ normals,\ uvs,\ \&dNdU,\ \&dNdV))}
\DoxyCodeLine{00172\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00173\ \ \ \ \ \ \ \ \ \ \ \ \ dNdU.\mbox{\hyperlink{classph_1_1math_1_1_t_vector_n_base_a66bef10def6b7cfc11adea52b28094e0}{set}}(0);\ dNdV.\mbox{\hyperlink{classph_1_1math_1_1_t_vector_n_base_a66bef10def6b7cfc11adea52b28094e0}{set}}(0);}
\DoxyCodeLine{00174\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00175\ \ \ \ \ \}}
\DoxyCodeLine{00176\ }
\DoxyCodeLine{00177\ \ \ \ \ PH\_ASSERT\_MSG(dPdU.isFinite()\ \&\&\ dPdV.\mbox{\hyperlink{classph_1_1math_1_1_t_vector_n_base_aabbf0b0d4f4d90122f70331d072aaaa5}{isFinite}}()\ \&\&}
\DoxyCodeLine{00178\ \ \ \ \ \ \ \ \ dNdU.isFinite()\ \&\&\ dNdV.\mbox{\hyperlink{classph_1_1math_1_1_t_vector_n_base_aabbf0b0d4f4d90122f70331d072aaaa5}{isFinite}}(),\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}}}
\DoxyCodeLine{00179\ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}dPdU\ =\ "{}}\ +\ dPdU.toString()\ +\ \textcolor{stringliteral}{"{},\ dPdV\ =\ "{}}\ +\ dPdV.\mbox{\hyperlink{classph_1_1math_1_1_t_vector_n_base_a945f66ed8e65964d232f259b223debd1}{toString}}()\ +\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}}}
\DoxyCodeLine{00180\ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}dNdU\ =\ "{}}\ +\ dNdU.toString()\ +\ \textcolor{stringliteral}{"{},\ dNdV\ =\ "{}}\ +\ dNdV.\mbox{\hyperlink{classph_1_1math_1_1_t_vector_n_base_a945f66ed8e65964d232f259b223debd1}{toString}}()\ +\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}});}
\DoxyCodeLine{00181\ \ \ \ \ }
\DoxyCodeLine{00182\ \ \ \ \ out\_detail-\/>\mbox{\hyperlink{classph_1_1_hit_detail_ac65eefb38c426f807896dec82f2fb39c}{setHitIntrinsics}}(}
\DoxyCodeLine{00183\ \ \ \ \ \ \ \ \ \textcolor{keyword}{this},\ }
\DoxyCodeLine{00184\ \ \ \ \ \ \ \ \ uvw,\ }
\DoxyCodeLine{00185\ \ \ \ \ \ \ \ \ probe.\mbox{\hyperlink{classph_1_1_hit_probe_af9c96bd20f167c30fe8802524c563a21}{getHitRayT}}(),}
\DoxyCodeLine{00186\ \ \ \ \ \ \ \ \ lossless\_cast<uint64>(closestHit.faceIdx),}
\DoxyCodeLine{00187\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classph_1_1_t_bit_flags}{FaceTopology}}(\{EFaceTopology::Planar,\ EFaceTopology::Triangular\}));}
\DoxyCodeLine{00188\ \ \ \ \ out\_detail-\/>\mbox{\hyperlink{classph_1_1_hit_detail_aeb5a6edc287e88399235abb9456f9759}{getHitInfo}}(ECoordSys::Local).\mbox{\hyperlink{classph_1_1_hit_info_afc21b88e4ee25dcae879d22505ee7e20}{setAttributes}}(}
\DoxyCodeLine{00189\ \ \ \ \ \ \ \ \ position,}
\DoxyCodeLine{00190\ \ \ \ \ \ \ \ \ faceNormal,}
\DoxyCodeLine{00191\ \ \ \ \ \ \ \ \ shadingNormal);}
\DoxyCodeLine{00192\ \ \ \ \ out\_detail-\/>\mbox{\hyperlink{classph_1_1_hit_detail_aeb5a6edc287e88399235abb9456f9759}{getHitInfo}}(ECoordSys::Local).\mbox{\hyperlink{classph_1_1_hit_info_aa85b1ef50e4c631b3145ea69f9180f22}{setDerivatives}}(}
\DoxyCodeLine{00193\ \ \ \ \ \ \ \ \ dPdU,\ dPdV,\ dNdU,\ dNdV);}
\DoxyCodeLine{00194\ \ \ \ \ out\_detail-\/>\mbox{\hyperlink{classph_1_1_hit_detail_aeb5a6edc287e88399235abb9456f9759}{getHitInfo}}(ECoordSys::World)\ =\ out\_detail-\/>\mbox{\hyperlink{classph_1_1_hit_detail_aeb5a6edc287e88399235abb9456f9759}{getHitInfo}}(ECoordSys::Local);}
\DoxyCodeLine{00195\ }
\DoxyCodeLine{00196\ \ \ \ \ \textcolor{keyword}{constexpr}\ \textcolor{keyword}{auto}\ meanFactor\ =\ 5e-\/8\_r;}
\DoxyCodeLine{00197\ \ \ \ \ out\_detail-\/>\mbox{\hyperlink{classph_1_1_hit_detail_a61a79e52716bc841b425fc96902b41c0}{setDistanceErrorFactors}}(meanFactor,\ meanFactor\ *\ 5e2\_r);}
\DoxyCodeLine{00198\ \}}
\DoxyCodeLine{00199\ }
\DoxyCodeLine{00200\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ Index>}
\DoxyCodeLine{00201\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1math_1_1_t_a_a_b_b3_d}{math::AABB3D}}\ \mbox{\hyperlink{classph_1_1_t_p_indexed_kd_tree_triangle_mesh}{TPIndexedKdTreeTriangleMesh<Index>::calcAABB}}()\textcolor{keyword}{\ const}}
\DoxyCodeLine{00202\ \textcolor{keyword}{}\{}
\DoxyCodeLine{00203\ \ \ \ \ \textcolor{keywordflow}{return}\ m\_kdTree.getAABB();}
\DoxyCodeLine{00204\ \}}
\DoxyCodeLine{00205\ }
