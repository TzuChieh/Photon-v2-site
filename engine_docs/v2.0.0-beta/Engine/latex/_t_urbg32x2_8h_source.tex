...
\DoxyCodeLine{00055\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keyword}{auto}\ higher4B\ =\ uint64(m\_urbg1.template\ generate<uint32>())\ <<\ 32;}
\DoxyCodeLine{00056\ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keyword}{auto}\ lower4B\ =\ uint64(m\_urbg2.template\ generate<uint32>());}
