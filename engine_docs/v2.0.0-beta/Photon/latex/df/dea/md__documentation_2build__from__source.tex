...
\label{md__documentation_2build__from__source_autotoc_md7}%
\Hypertarget{md__documentation_2build__from__source_autotoc_md7}%
 Building Photon is super easy since the renderer is coded from scratch (almost) using standard C++. Each of the required third-\/party libraries is either header only or pre-\/compiled, and can be handled automatically with the setup script.\hypertarget{md__documentation_2build__from__source_autotoc_md8}{}\doxysection{\texorpdfstring{Prerequisites}{Prerequisites}}\label{md__documentation_2build__from__source_autotoc_md8}
...
{\itshape Note that the working directory is assumed to be the project root (in the folder that you cloned) if not stated , and please use {\ttfamily ./build/} as build folder for now since build scripts are more or less hard-\/coded to use this path, currently.}\hypertarget{md__documentation_2build__from__source_autotoc_md9}{}\doxysection{\texorpdfstring{Step 1\+: Run the Setup Script}{Step 1: Run the Setup Script}}\label{md__documentation_2build__from__source_autotoc_md9}
Run the setup script (depending on your system, choose either {\ttfamily ./setup.bat} or {\ttfamily ./setup.sh}), this will download pre-\/compiled libraries and resources into "{}./build"{}.\hypertarget{md__documentation_2build__from__source_autotoc_md10}{}\doxysection{\texorpdfstring{Step 2\+: Compile}{Step 2: Compile}}\label{md__documentation_2build__from__source_autotoc_md10}
...
\item {\ttfamily make}
\end{DoxyItemize}\hypertarget{md__documentation_2build__from__source_autotoc_md11}{}\doxysection{\texorpdfstring{Step 3\+: Have Fun}{Step 3: Have Fun}}\label{md__documentation_2build__from__source_autotoc_md11}
The compiled binaries will be in the {\ttfamily ./build/bin/} folder.\hypertarget{md__documentation_2build__from__source_autotoc_md12}{}\doxysection{\texorpdfstring{Appendix A\+: Available CMake Options}{Appendix A: Available CMake Options}}\label{md__documentation_2build__from__source_autotoc_md12}
