...
\label{md__documentation_2coding__standard_autotoc_md13}%
\Hypertarget{md__documentation_2coding__standard_autotoc_md13}%
 The development of the core of Photon complies to a collection of rules.\hypertarget{md__documentation_2coding__standard_autotoc_md14}{}\doxysection{\texorpdfstring{Why}{Why}}\label{md__documentation_2coding__standard_autotoc_md14}
...
This guideline is for coding in C++ since most of the code for engine is written in it; nonetheless, some concepts can be applied to other parts of Photon (and is encouraged). You do not need to follow all these rules strictly as long as you have a good reason that doing the other way is better for the context.\hypertarget{md__documentation_2coding__standard_autotoc_md15}{}\doxysection{\texorpdfstring{Language and Naming}{Language and Naming}}\label{md__documentation_2coding__standard_autotoc_md15}
...
\end{DoxyItemize}\hypertarget{md__documentation_2coding__standard_autotoc_md16}{}\doxysection{\texorpdfstring{Filename Extensions and Includes}{Filename Extensions and Includes}}\label{md__documentation_2coding__standard_autotoc_md16}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__documentation_2coding__standard_autotoc_md17}{}\doxysection{\texorpdfstring{Formatting}{Formatting}}\label{md__documentation_2coding__standard_autotoc_md17}
...
\end{DoxyItemize}\hypertarget{md__documentation_2coding__standard_autotoc_md18}{}\doxysection{\texorpdfstring{C++ Syntax}{C++ Syntax}}\label{md__documentation_2coding__standard_autotoc_md18}
...
\end{DoxyItemize}\hypertarget{md__documentation_2coding__standard_autotoc_md19}{}\doxysection{\texorpdfstring{Primitive Type Aliasing}{Primitive Type Aliasing}}\label{md__documentation_2coding__standard_autotoc_md19}
...
\end{DoxyItemize}\hypertarget{md__documentation_2coding__standard_autotoc_md20}{}\doxysection{\texorpdfstring{Others}{Others}}\label{md__documentation_2coding__standard_autotoc_md20}
