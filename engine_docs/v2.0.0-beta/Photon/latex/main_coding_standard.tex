...
\hypertarget{main_coding_standard}{}\label{main_coding_standard}\index{Coding Standard@{Coding Standard}}
\label{main_coding_standard_md__documentation_2coding__standard}%
\Hypertarget{main_coding_standard_md__documentation_2coding__standard}%


The development of the core of Photon complies to a collection of rules.\hypertarget{main_coding_standard_autotoc_md11}{}\doxysection{\texorpdfstring{Why}{Why}}\label{main_coding_standard_autotoc_md11}
...
This guideline is for coding in C++ since most of the code for engine is written in it; nonetheless, some concepts can be applied to other parts of Photon (and is encouraged). You do not need to follow all these rules strictly as long as you have a good reason that doing the other way is better for the context.\hypertarget{main_coding_standard_autotoc_md12}{}\doxysection{\texorpdfstring{Language and Naming}{Language and Naming}}\label{main_coding_standard_autotoc_md12}
...
\end{DoxyItemize}\hypertarget{main_coding_standard_autotoc_md13}{}\doxysection{\texorpdfstring{Filename Extensions and Includes}{Filename Extensions and Includes}}\label{main_coding_standard_autotoc_md13}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{main_coding_standard_autotoc_md14}{}\doxysection{\texorpdfstring{Formatting}{Formatting}}\label{main_coding_standard_autotoc_md14}
...
\end{DoxyItemize}\hypertarget{main_coding_standard_autotoc_md15}{}\doxysection{\texorpdfstring{C++ Syntax}{C++ Syntax}}\label{main_coding_standard_autotoc_md15}
...
\end{DoxyItemize}\hypertarget{main_coding_standard_autotoc_md16}{}\doxysection{\texorpdfstring{Primitive Type Aliasing}{Primitive Type Aliasing}}\label{main_coding_standard_autotoc_md16}
...
\end{DoxyItemize}\hypertarget{main_coding_standard_autotoc_md17}{}\doxysection{\texorpdfstring{Others}{Others}}\label{main_coding_standard_autotoc_md17}
