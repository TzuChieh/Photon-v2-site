...
\end{DoxyImage}
   \hypertarget{main_feature_overview_autotoc_md23}{}\doxysubsection{\texorpdfstring{Procedural Image}{Procedural Image}}\label{main_feature_overview_autotoc_md23}
Our image implementations also support generating some interesting patterns or performing some mathematical operations on the fly. Procedural images are useful for producing a wide variety of effects with unlimited resolution and are generally more memory-\/efficient than \doxysectlink{main_feature_overview_raster_image}{raster images}{2}.\hypertarget{main_feature_overview_autotoc_md24}{}\doxysubsubsection{\texorpdfstring{Checkerboard Pattern}{Checkerboard Pattern}}\label{main_feature_overview_autotoc_md24}
\textbf{ Checkerboard image} is a procedural image that divides its parametric domain into rectangular tiles. The frequency of the tiles can be adjusted individually in the U and V dimensions, and the content of the tiles can be specified by referencing other images.
...
\begin{DoxyInlineImage}
\includegraphics[height=\baselineskip,keepaspectratio=true]{checkerboard_u10_v3.jpg}%Color Tiles
\end{DoxyInlineImage}
      }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{  
\begin{DoxyInlineImage}
\includegraphics[height=\baselineskip,keepaspectratio=true]{checkerboard_u2_v2_photo.jpg}%Image Tiles
\end{DoxyInlineImage}
       }\\\cline{1-2}
\endfirsthead
\hline
...
\endhead
\multicolumn{2}{|c|}{\PBS\centering {\bfseries{Left\+: U frequency = 10, V frequency = 3. Right\+: Using images to fill the tiles.}}   }\\\cline{1-2}
\end{longtabu}
\hypertarget{main_feature_overview_autotoc_md25}{}\doxysubsubsection{\texorpdfstring{Smooth Gradient}{Smooth Gradient}}\label{main_feature_overview_autotoc_md25}
\hypertarget{main_feature_overview_autotoc_md26}{}\doxysubsubsection{\texorpdfstring{Mathematical Operations}{Mathematical Operations}}\label{main_feature_overview_autotoc_md26}
\hypertarget{main_feature_overview_autotoc_md27}{}\doxysubsection{\texorpdfstring{Black-\/body Radiation}{Black-\/body Radiation}}\label{main_feature_overview_autotoc_md27}
...
\end{DoxyImage}
   \hypertarget{main_feature_overview_autotoc_md28}{}\doxysection{\texorpdfstring{Film}{Film}}\label{main_feature_overview_autotoc_md28}
\hypertarget{main_feature_overview_autotoc_md29}{}\doxysubsection{\texorpdfstring{Filtering}{Filtering}}\label{main_feature_overview_autotoc_md29}
\hypertarget{main_feature_overview_autotoc_md30}{}\doxysubsection{\texorpdfstring{Tone-\/mapping}{Tone-\/mapping}}\label{main_feature_overview_autotoc_md30}
\hypertarget{main_feature_overview_autotoc_md31}{}\doxysubsection{\texorpdfstring{Reading and Writing}{Reading and Writing}}\label{main_feature_overview_autotoc_md31}
...
\end{longtabu}
\hypertarget{main_feature_overview_autotoc_md33}{}\doxysubsection{\texorpdfstring{Ideal Substance}{Ideal Substance}}\label{main_feature_overview_autotoc_md33}
...
\end{longtabu}
\hypertarget{main_feature_overview_autotoc_md34}{}\doxysubsection{\texorpdfstring{Binary Mixed Surface}{Binary Mixed Surface}}\label{main_feature_overview_autotoc_md34}
...
\end{longtabu}
\hypertarget{main_feature_overview_autotoc_md35}{}\doxysubsection{\texorpdfstring{Layered Material}{Layered Material}}\label{main_feature_overview_autotoc_md35}
...
\end{DoxyImage}
   \hypertarget{main_feature_overview_autotoc_md36}{}\doxysubsection{\texorpdfstring{Thin Dielectric}{Thin Dielectric}}\label{main_feature_overview_autotoc_md36}
...
\end{DoxyNote}
\hypertarget{main_feature_overview_autotoc_md38}{}\doxysubsection{\texorpdfstring{Basic Shapes}{Basic Shapes}}\label{main_feature_overview_autotoc_md38}
...
\end{DoxyImage}
   \hypertarget{main_feature_overview_autotoc_md39}{}\doxysubsection{\texorpdfstring{Masking}{Masking}}\label{main_feature_overview_autotoc_md39}
While we offer flexible geometry representations such as \textbf{ triangle mesh} for modeling arbitrarily shaped objects, sometimes it is not worthwhile to explicitly store complex shapes using 3-\/D coordinates. Alpha masking is a common way to carve out intricate shapes from a simpler base geometry, and is a technique widely used on foliage and hair. We support masked geometries through \textbf{ AMasked\+Model}, which can be applied to any \textbf{ AModel} with proper surface parameterization. This is one of many techniques that enable \doxysectlink{main_feature_overview_image}{image}{1}-\/driven geometry.

 
\begin{DoxyImage}
\includegraphics[width=\textwidth,height=\textheight/2,keepaspectratio=true]{masked_fern_leaves.jpg}
\doxyfigcaption{Fern leaves modeled with alpha masking and thin dielectric material.}
\end{DoxyImage}
   \hypertarget{main_feature_overview_autotoc_md40}{}\doxysubsection{\texorpdfstring{Advanced Shapes}{Advanced Shapes}}\label{main_feature_overview_autotoc_md40}
...
These advanced shapes add versatility to scene modeling in Photon.\hypertarget{main_feature_overview_autotoc_md41}{}\doxysubsection{\texorpdfstring{Acceleration Structure}{Acceleration Structure}}\label{main_feature_overview_autotoc_md41}
\hypertarget{main_feature_overview_autotoc_md42}{}\doxysection{\texorpdfstring{Light}{Light}}\label{main_feature_overview_autotoc_md42}
...
\end{DoxyImage}
   \hypertarget{main_feature_overview_autotoc_md44}{}\doxysubsection{\texorpdfstring{Point Light}{Point Light}}\label{main_feature_overview_autotoc_md44}
...
\end{DoxyImage}
   \hypertarget{main_feature_overview_autotoc_md45}{}\doxysubsection{\texorpdfstring{Model Light}{Model Light}}\label{main_feature_overview_autotoc_md45}
...
\end{DoxyImage}
   \hypertarget{main_feature_overview_autotoc_md46}{}\doxysubsection{\texorpdfstring{IES Light Profiles}{IES Light Profiles}}\label{main_feature_overview_autotoc_md46}
...
\end{DoxyImage}
   \hypertarget{main_feature_overview_autotoc_md47}{}\doxysubsection{\texorpdfstring{Sky Dome}{Sky Dome}}\label{main_feature_overview_autotoc_md47}
...
\end{DoxyImage}
   \hypertarget{main_feature_overview_autotoc_md48}{}\doxysection{\texorpdfstring{Sample Source}{Sample Source}}\label{main_feature_overview_autotoc_md48}
\hypertarget{main_feature_overview_autotoc_md49}{}\doxysubsection{\texorpdfstring{Sample Generator}{Sample Generator}}\label{main_feature_overview_autotoc_md49}
\hypertarget{main_feature_overview_autotoc_md50}{}\doxysection{\texorpdfstring{Toolset}{Toolset}}\label{main_feature_overview_autotoc_md50}
Photon comes with a series of tools to facilitate scene rendering and management.\hypertarget{main_feature_overview_autotoc_md51}{}\doxysubsection{\texorpdfstring{Film Merger}{Film Merger}}\label{main_feature_overview_autotoc_md51}
