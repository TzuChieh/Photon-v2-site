...
\begin{DoxyImage}
\includegraphics[width=\textwidth,height=\textheight/2,keepaspectratio=true]{ideal_dielectric.jpg}
\doxyfigcaption{Ideal glass (index of refraction = 1.51714).}
\end{DoxyImage}
...
\endhead
\multicolumn{2}{|c|}{\PBS\centering {\bfseries{Left\+: Ideal glass with blue reflection tint. Right\+: Ideal glass with green transmission tint.}}   }\\\cline{1-2}
\end{longtabu}


 
\begin{DoxyImage}
\includegraphics[width=\textwidth,height=\textheight/2,keepaspectratio=true]{ideal_dielectric_blue_refl_green_refr_tint.jpg}
\doxyfigcaption{Ideal glass with blue reflection and green transmission tint.}
\end{DoxyImage}
   \hypertarget{main_feature_overview_autotoc_md31}{}\doxysubsection{\texorpdfstring{Ideal Substance}{Ideal Substance}}\label{main_feature_overview_autotoc_md31}
\hypertarget{main_feature_overview_autotoc_md32}{}\doxysubsection{\texorpdfstring{Abraded Opaque}{Abraded Opaque}}\label{main_feature_overview_autotoc_md32}
\hypertarget{main_feature_overview_autotoc_md33}{}\doxysubsection{\texorpdfstring{Abraded Translucent}{Abraded Translucent}}\label{main_feature_overview_autotoc_md33}
...
\hypertarget{main_feature_overview_autotoc_md36}{}\doxysubsection{\texorpdfstring{Surface Behavior}{Surface Behavior}}\label{main_feature_overview_autotoc_md36}
\hypertarget{main_feature_overview_autotoc_md37}{}\doxysubsection{\texorpdfstring{Volume Behavior}{Volume Behavior}}\label{main_feature_overview_autotoc_md37}
...
\end{DoxyNote}
\hypertarget{main_feature_overview_autotoc_md39}{}\doxysubsection{\texorpdfstring{Basic Shapes}{Basic Shapes}}\label{main_feature_overview_autotoc_md39}
