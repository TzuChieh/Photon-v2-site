...
\begin{DoxyInlineImage}
\includegraphics[height=\baselineskip,keepaspectratio=true]{microfacet_gold_0p5.jpg}%Microfacet Gold
\end{DoxyInlineImage}
       }\\\cline{1-2}
\endfirsthead
\hline
...
NDFs other than Trowbridge-\/\+Reitz are also supported, see \textbf{ here}. Roughness values are often remapped to the $ \alpha $ parameter in the NDF, we have implementations for some \textbf{ common mappings}. The masking and shadowing terms in a microfacet BRDF often have some kind of correlation \cite{Heitz:2014:Microfacet}, and we provide some \textbf{ common forms} to choose from.\hypertarget{main_feature_overview_autotoc_md32}{}\doxysubsection{\texorpdfstring{Abraded Translucent}{Abraded Translucent}}\label{main_feature_overview_autotoc_md32}
A good reference of microfacet models is the paper (“\+Microfacet Models for Refraction through Rough Surfaces”, EGSR07) written by Walter et al.\hypertarget{main_feature_overview_autotoc_md33}{}\doxysubsection{\texorpdfstring{Binary Mixed Surface}{Binary Mixed Surface}}\label{main_feature_overview_autotoc_md33}
