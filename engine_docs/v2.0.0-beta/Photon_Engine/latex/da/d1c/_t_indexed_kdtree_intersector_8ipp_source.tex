...
\hypertarget{_t_indexed_kdtree_intersector_8ipp_source}{}\label{_t_indexed_kdtree_intersector_8ipp_source}\index{Source/Core/Intersectable/Intersector/TIndexedKdtreeIntersector.ipp@{Source/Core/Intersectable/Intersector/TIndexedKdtreeIntersector.ipp}}

\begin{DoxyCode}{0}
\DoxyCodeLine{00001\ \textcolor{preprocessor}{\#pragma\ once}}
\DoxyCodeLine{00002\ }
\DoxyCodeLine{00003\ \textcolor{preprocessor}{\#include\ "{}Core/Intersectable/Intersector/TIndexedKdtreeIntersector.h"{}}}
...
\DoxyCodeLine{00013\ \textcolor{keyword}{inline}\ TIndexedKdtreeIntersector<Index>::}
\DoxyCodeLine{00014\ TIndexedKdtreeIntersector(\textcolor{keyword}{const}\ math::IndexedKdtreeParams\ params)\ :}
\DoxyCodeLine{00015\ }
\DoxyCodeLine{00016\ \ \ \ \ Intersector(),}
\DoxyCodeLine{00017\ }
...
\DoxyCodeLine{00027\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ TIndexedKdtreeIntersector<Index>::}
\DoxyCodeLine{00028\ update(TSpanView<const\ Intersectable*>\ intersectables)}
\DoxyCodeLine{00029\ \{}
\DoxyCodeLine{00030\ \ \ \ \ IndexedIntersectables\ indexedIntersectables;}
\DoxyCodeLine{00031\ \ \ \ \ \textcolor{keywordflow}{for}(\textcolor{keyword}{const}\ Intersectable*\ intersectable\ :\ intersectables)}
\DoxyCodeLine{00032\ \ \ \ \ \{}
...
\DoxyCodeLine{00043\ \ \ \ \ m\_tree\ =\ Tree(}
...
\DoxyCodeLine{00051\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ \mbox{\hyperlink{classph_1_1_t_indexed_kdtree_intersector}{TIndexedKdtreeIntersector<Index>::}}}
\DoxyCodeLine{00052\ \mbox{\hyperlink{classph_1_1_t_indexed_kdtree_intersector}{isIntersecting}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1_ray}{Ray}}\&\ ray,\ \mbox{\hyperlink{classph_1_1_hit_probe}{HitProbe}}\&\ probe)\ \textcolor{keyword}{const}}
