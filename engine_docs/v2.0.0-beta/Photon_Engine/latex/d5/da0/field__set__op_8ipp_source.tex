...
\DoxyCodeLine{00059\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}SDL\ class\ <"{}}\ +\ ctx.\mbox{\hyperlink{classph_1_1_sdl_i_o_context_a1c1c2c49c727cd53dd35f037eb2db9c8}{genPrettySrcClassName}}()\ +\ \textcolor{stringliteral}{"{}>\ has\ no\ matching\ field\ for\ "{}}}
\DoxyCodeLine{00060\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}input\ clause\ <"{}}\ +\ clause.genPrettyName()\ +\ \textcolor{stringliteral}{"{}>,\ ignoring"{}},}
...
\DoxyCodeLine{00085\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}no\ clause\ for\ "{}}\ +\ \mbox{\hyperlink{namespaceph_1_1sdl_a16ba8b83316ce0f172ca13981e342faf}{sdl::gen\_pretty\_name}}(ctx.\mbox{\hyperlink{classph_1_1_sdl_i_o_context_a5b9c08b5228d2e5e4718e08485cb83d5}{getSrcClass}}(),\ \&field)\ +}
\DoxyCodeLine{00086\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{},\ defaults\ to\ <"{}}\ +\ field.valueToString(owner)\ +\ \textcolor{stringliteral}{"{}>"{}},}
\DoxyCodeLine{00087\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ importance);}
\DoxyCodeLine{00088\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00089\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00090\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}}
\DoxyCodeLine{00091\ \ \ \ \ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00092\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ For\ importance\ levels\ other\ than\ optional,\ uninitialized\ field\ is\ an\ error}}
\DoxyCodeLine{00093\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(importance\ !=\ \mbox{\hyperlink{namespaceph_a3f81b078141211109d7e3b340d0525ccaebb061953c0454b2c8ee7b0ac615ebcd}{EFieldImportance::Optional}})}
\DoxyCodeLine{00094\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00095\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{throw}\ \mbox{\hyperlink{classph_1_1_sdl_load_error}{SdlLoadError}}(}
\DoxyCodeLine{00096\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{stringliteral}{"{}a\ clause\ for\ value\ <"{}}\ +\ field.genPrettyName()\ +\ \textcolor{stringliteral}{"{}>\ is\ required"{}});}
\DoxyCodeLine{00097\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00098\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00099\ }
\DoxyCodeLine{00100\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ TODO:\ util\ for\ generating\ class\ +\ field\ info\ string}}
\DoxyCodeLine{00101\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00102\ \ \ \ \ \}}
\DoxyCodeLine{00103\ \}}
\DoxyCodeLine{00104\ }
\DoxyCodeLine{00105\ \textcolor{keyword}{template}<}
\DoxyCodeLine{00106\ \ \ \ \ \textcolor{keyword}{typename}\ Owner,}
\DoxyCodeLine{00107\ \ \ \ \ \textcolor{keyword}{typename}\ FieldSet,}
\DoxyCodeLine{00108\ \ \ \ \ \textcolor{keyword}{typename}\ NoticeReceiver>}
\DoxyCodeLine{00109\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{namespaceph_1_1field__set__op_ab11e22444f68057b00a8b86fc071b7d6}{load\_fields\_from\_sdl\_with\_redundant\_clauses}}(}
\DoxyCodeLine{00110\ \ \ \ \ Owner\&\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ owner,}
\DoxyCodeLine{00111\ \ \ \ \ FieldSet\&\ \ \ \ \ \ \ \ \ \ \ \ \ \ fieldSet,}
\DoxyCodeLine{00112\ \ \ \ \ \mbox{\hyperlink{classph_1_1_sdl_input_clauses}{SdlInputClauses}}\&\ \ \ \ \ \ \ clauses,}
\DoxyCodeLine{00113\ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1_sdl_input_context}{SdlInputContext}}\&\ ctx,}
\DoxyCodeLine{00114\ \ \ \ \ NoticeReceiver\ \ \ \ \ \ \ \ \ noticeReceiver)}
\DoxyCodeLine{00115\ \{}
\DoxyCodeLine{00116\ \ \ \ \ load\_fields\_from\_sdl<Owner,\ FieldSet,\ NoticeReceiver,\ false>(}
\DoxyCodeLine{00117\ \ \ \ \ \ \ \ \ owner,}
\DoxyCodeLine{00118\ \ \ \ \ \ \ \ \ fieldSet,}
\DoxyCodeLine{00119\ \ \ \ \ \ \ \ \ clauses,}
\DoxyCodeLine{00120\ \ \ \ \ \ \ \ \ ctx,}
\DoxyCodeLine{00121\ \ \ \ \ \ \ \ \ std::move(noticeReceiver));}
\DoxyCodeLine{00122\ \}}
\DoxyCodeLine{00123\ }
\DoxyCodeLine{00124\ \}\textcolor{comment}{//\ end\ namespace\ ph::field\_set\_op}}
