...
\DoxyCodeLine{00005\ \textcolor{preprocessor}{\#include\ "{}Utility/Concurrent/FixedSizeThreadPool.h"{}}}
\DoxyCodeLine{00006\ \textcolor{preprocessor}{\#include\ "{}Math/Function/TConstant2D.h"{}}}
...
\DoxyCodeLine{00021\ \ \ \ \ \mbox{\hyperlink{classph_1_1mipmapgen}{mipmapgen}}(\textcolor{keyword}{const}\ std::size\_t\ numThreads);}
\DoxyCodeLine{00022\ \ \ \ \ \mbox{\hyperlink{classph_1_1mipmapgen}{\string~mipmapgen}}()}
\DoxyCodeLine{00023\ \ \ \ \ \{}
...
\DoxyCodeLine{00033\ \ \ \ \ \textcolor{keyword}{using\ }Mipmaps\ =\ std::vector<TFrame<T,\ N>>;}
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00035\ \ \ \ \ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ T,\ std::\textcolor{keywordtype}{size\_t}\ N>}
\DoxyCodeLine{00036\ \ \ \ \ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ genMipmaps(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1_t_frame}{TFrame<T,\ N>}}\&\ source)\ }
...
\DoxyCodeLine{00050\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}(\mbox{\hyperlink{namespaceph_1_1math_a2db200d8e62c40799c3fff427b4d869d}{math::is\_power\_of\_2}}(src.widthPx())\ \&\&\ \mbox{\hyperlink{namespaceph_1_1math_a2db200d8e62c40799c3fff427b4d869d}{math::is\_power\_of\_2}}(src.heightPx()))}
\DoxyCodeLine{00051\ \ \ \ \ \ \ \ \ \ \ \ \ \{}
...
\DoxyCodeLine{00061\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00062\ }
\DoxyCodeLine{00063\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ std::size\_t\ numMipmapLevels\ =\ 1\ +\ \mbox{\hyperlink{namespaceph_1_1math_aef693a3af48988419e383d739b935a4b}{math::log2\_floor}}(std::max(level0.widthPx(),\ level0.heightPx()));}
\DoxyCodeLine{00064\ \ \ \ \ \ \ \ \ \ \ \ \ Mipmaps<T,\ N>\ mipmaps(numMipmapLevels);}
