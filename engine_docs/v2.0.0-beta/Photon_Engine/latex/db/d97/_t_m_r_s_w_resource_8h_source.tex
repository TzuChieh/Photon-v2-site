...
\DoxyCodeLine{00030\ \ \ \ \ \textcolor{keywordtype}{void}\ read(Reader\ reader)\ \textcolor{keyword}{const};}
\DoxyCodeLine{00031\ }
...
\DoxyCodeLine{00035\ \ \ \ \ \textcolor{keywordtype}{void}\ write(Writer\ writer);}
\DoxyCodeLine{00036\ }
...
\DoxyCodeLine{00040\ \ \ \ \ \textcolor{keywordtype}{bool}\ tryRead(Reader\ reader)\ \textcolor{keyword}{const};}
\DoxyCodeLine{00041\ }
...
\DoxyCodeLine{00045\ \ \ \ \ \textcolor{keywordtype}{bool}\ tryWrite(Writer\ writer);}
\DoxyCodeLine{00046\ }
...
\DoxyCodeLine{00050\ \ \ \ \ \textcolor{keywordtype}{void}\ directCall(Operation\ operation);}
\DoxyCodeLine{00051\ }
...
\DoxyCodeLine{00060\ \ \ \ \ \mbox{\hyperlink{classph_1_1_t_m_r_s_w_resource}{TMRSWResource}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1_t_m_r_s_w_resource}{TMRSWResource}}\&\ other)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00061\ \ \ \ \ \mbox{\hyperlink{classph_1_1_t_m_r_s_w_resource}{TMRSWResource}}\&\ operator\ =\ (\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1_t_m_r_s_w_resource}{TMRSWResource}}\&\ rhs)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00062\ \ \ \ \ \mbox{\hyperlink{classph_1_1_t_m_r_s_w_resource}{TMRSWResource}}(\mbox{\hyperlink{classph_1_1_t_m_r_s_w_resource}{TMRSWResource}}\&\&\ other)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00063\ \ \ \ \ \mbox{\hyperlink{classph_1_1_t_m_r_s_w_resource}{TMRSWResource}}\&\ operator\ =\ (\mbox{\hyperlink{classph_1_1_t_m_r_s_w_resource}{TMRSWResource}}\&\&\ rhs)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00064\ }
...
\DoxyCodeLine{00074\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{classph_1_1_t_m_r_s_w_resource}{TMRSWResource<Resource>::TMRSWResource}}(Res\&\&\ resource)\ :}
\DoxyCodeLine{00075\ \ \ \ \ m\_mutex(),\ m\_resource(std::forward<Res>(resource))}
\DoxyCodeLine{00076\ \{\}}
\DoxyCodeLine{00077\ }
...
\DoxyCodeLine{00080\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ TMRSWResource<Resource>::read(Reader\ reader)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00089\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ TMRSWResource<Resource>::write(Writer\ writer)}
\DoxyCodeLine{00090\ \{}
...
\DoxyCodeLine{00098\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ TMRSWResource<Resource>::tryRead(Reader\ reader)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00115\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ TMRSWResource<Resource>::tryWrite(Writer\ writer)}
\DoxyCodeLine{00116\ \{}
...
\DoxyCodeLine{00132\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ TMRSWResource<Resource>::directCall(Operation\ operation)}
\DoxyCodeLine{00133\ \{}
