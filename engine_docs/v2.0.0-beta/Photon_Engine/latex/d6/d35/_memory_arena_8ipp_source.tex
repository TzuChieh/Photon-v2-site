...
\DoxyCodeLine{00042\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{namespaceph_ac5bb03de153dde37c41cddcbfd29596c}{TSpan<T>}}\ \mbox{\hyperlink{classph_1_1_memory_arena_a5b0c2b5fd02dd563ad70bf9c034457f1}{MemoryArena::allocArray}}(\textcolor{keyword}{const}\ std::size\_t\ arraySize)}
\DoxyCodeLine{00043\ \{}
...
\DoxyCodeLine{00050\ }
\DoxyCodeLine{00051\ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespaceph_ac5bb03de153dde37c41cddcbfd29596c}{TSpan<T>}}(storage,\ arraySize);}
\DoxyCodeLine{00052\ \}}
\DoxyCodeLine{00053\ }
...
\DoxyCodeLine{00058\ \ \ \ \ \{}
\DoxyCodeLine{00059\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ std::construct\_at(alloc<T>(),\ std::forward<Args>(args)...);}
\DoxyCodeLine{00060\ \ \ \ \ \}}
