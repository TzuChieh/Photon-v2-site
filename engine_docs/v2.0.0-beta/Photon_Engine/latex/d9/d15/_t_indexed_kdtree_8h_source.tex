...
\DoxyCodeLine{00006\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{_t_indexed_item_endpoint_8h}{Math/Algorithm/IndexedKdtree/TIndexedItemEndpoint.h}}"{}}}
\DoxyCodeLine{00007\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{_ray_8h}{Core/Ray.h}}"{}}}
\DoxyCodeLine{00008\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{_hit_probe_8h}{Core/HitProbe.h}}"{}}}
\DoxyCodeLine{00009\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{_t_line_segment_8h}{Math/Geometry/TLineSegment.h}}"{}}}
\DoxyCodeLine{00010\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{_indexed_kdtree_params_8h}{Math/Algorithm/IndexedKdtree/IndexedKdtreeParams.h}}"{}}}
\DoxyCodeLine{00011\ }
...
\DoxyCodeLine{00075\ \ \ \ \ \textcolor{keywordtype}{void}\ build(ItemToAABB\ itemToAABB,\ \mbox{\hyperlink{classph_1_1math_1_1_indexed_kdtree_params}{IndexedKdtreeParams}}\ params);}
\DoxyCodeLine{00076\ }
\DoxyCodeLine{00077\ \ \ \ \ \textcolor{keywordtype}{void}\ buildNodeRecursive(}
\DoxyCodeLine{00078\ \ \ \ \ \ \ \ \ std::size\_t\ nodeIndex,}
\DoxyCodeLine{00079\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1math_1_1_t_a_a_b_b3_d}{AABB3D}}\&\ nodeAABB,}
\DoxyCodeLine{00080\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Index*\ nodeItemIndices,}
\DoxyCodeLine{00081\ \ \ \ \ \ \ \ \ std::size\_t\ numNodeItems,}
\DoxyCodeLine{00082\ \ \ \ \ \ \ \ \ std::size\_t\ currentNodeDepth,}
\DoxyCodeLine{00083\ \ \ \ \ \ \ \ \ std::size\_t\ currentBadRefines,}
\DoxyCodeLine{00084\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ std::vector<AABB3D>\&\ itemAABBs,}
\DoxyCodeLine{00085\ \ \ \ \ \ \ \ \ std::size\_t\ maxNodeDepth,}
\DoxyCodeLine{00086\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classph_1_1math_1_1_indexed_kdtree_params}{IndexedKdtreeParams}}\ params,}
\DoxyCodeLine{00087\ \ \ \ \ \ \ \ \ Index*\ negativeItemIndicesCache,}
\DoxyCodeLine{00088\ \ \ \ \ \ \ \ \ Index*\ positiveItemIndicesCache,}
\DoxyCodeLine{00089\ \ \ \ \ \ \ \ \ std::array<std::unique\_ptr<\mbox{\hyperlink{structph_1_1math_1_1_t_indexed_item_endpoint}{ItemEndpoint}}[]>,\ 3>\&\ endpointsCache);}
\DoxyCodeLine{00090\ }
\DoxyCodeLine{00091\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00092\ \ \ \ \ std::size\_t\ \ \ \ \ \ \ \ m\_numItems;}
\DoxyCodeLine{00093\ \ \ \ \ IndexToItem\ \ \ \ \ \ \ \ m\_indexToItem;}
\DoxyCodeLine{00094\ \ \ \ \ \mbox{\hyperlink{classph_1_1math_1_1_t_a_a_b_b3_d}{AABB3D}}\ \ \ \ \ \ \ \ \ \ \ \ \ m\_rootAABB;}
\DoxyCodeLine{00095\ \ \ \ \ std::vector<Node>\ \ m\_nodeBuffer;\textcolor{comment}{//\ TODO:\ compact\ this\ after\ build\ or\ use\ array}}
\DoxyCodeLine{00096\ \ \ \ \ std::size\_t\ \ \ \ \ \ \ \ m\_numNodes;\textcolor{comment}{//\ TODO:\ remove\ this}}
\DoxyCodeLine{00097\ \ \ \ \ std::vector<Index>\ m\_itemIndices;\textcolor{comment}{//\ TODO:\ compact\ this\ after\ build\ or\ use\ array}}
\DoxyCodeLine{00098\ \};}
\DoxyCodeLine{00099\ }
\DoxyCodeLine{00100\ \}\textcolor{comment}{//\ end\ namespace\ ph::math}}
\DoxyCodeLine{00101\ }
\DoxyCodeLine{00102\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{_t_indexed_kdtree_8ipp}{Math/Algorithm/IndexedKdtree/TIndexedKdtree.ipp}}"{}}}
