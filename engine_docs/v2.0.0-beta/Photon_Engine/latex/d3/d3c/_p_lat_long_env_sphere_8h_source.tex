...
\DoxyCodeLine{00007\ \textcolor{preprocessor}{\#include\ "{}Math/Transform/StaticRigidTransform.h"{}}}
\DoxyCodeLine{00008\ }
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ \ \ \ \ \textcolor{keywordtype}{bool}\ latLong01ToSurface(}
...
\DoxyCodeLine{00056\ \ \ \ \ \textcolor{keyword}{auto}\ effectiveVolume\ =\ volume.getTranslated(m\_worldOrigin.negate());}
...
\DoxyCodeLine{00063\ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classph_1_1_p_basic_sphere_a75e188eb9cbc9915c9072e741495ec30}{PBasicSphere::calcAABB}}().translate(m\_worldOrigin);}
\DoxyCodeLine{00064\ \}}
\DoxyCodeLine{00065\ }
