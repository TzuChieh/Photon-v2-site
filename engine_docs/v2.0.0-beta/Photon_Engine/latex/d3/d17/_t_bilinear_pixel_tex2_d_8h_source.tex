...
\DoxyCodeLine{00017\ \ \ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{classph_1_1_t_pixel_tex2_d}{TPixelTex2D}}<T,\ N>::TPixelTex2D;}
\DoxyCodeLine{00018\ }
\DoxyCodeLine{00019\ \ \ \ \ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ sample(}
...
\DoxyCodeLine{00023\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ float64\ u\ =\ sampleLocation.uvw().x();}
\DoxyCodeLine{00024\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ float64\ v\ =\ sampleLocation.uvw().y();}
\DoxyCodeLine{00025\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ uint32\ \ w\ =\ this-\/>getWidthPx();}
\DoxyCodeLine{00026\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ uint32\ \ h\ =\ this-\/>getHeightPx();}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \ \ \ \ \ \ \ \ PH\_ASSERT(w\ !=\ 0\ \&\&\ h\ !=\ 0);}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \ \ \ \ \ \ \ \ float64\ normU,\ normV;}
\DoxyCodeLine{00031\ \ \ \ \ \ \ \ \ this-\/>normalizeUV(u,\ v,\ \&normU,\ \&normV);}
\DoxyCodeLine{00032\ }
...
\DoxyCodeLine{00057\ \ \ \ \ \ \ \ \ \ \ \ \ this-\/>normalizeUV(xys[i].x()\ *\ this-\/>getTexelSizeU(),}
\DoxyCodeLine{00058\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ xys[i].y()\ *\ this-\/>getTexelSizeV(),}
...
\DoxyCodeLine{00065\ }
\DoxyCodeLine{00066\ \ \ \ \ \ \ \ \ \ \ \ \ this-\/>getPixel(xi,\ yi,\ \&pixel);}
\DoxyCodeLine{00067\ \ \ \ \ \ \ \ \ \ \ \ \ accuPixel.addLocal(\mbox{\hyperlink{classph_1_1math_1_1_t_arithmetic_array}{TTexPixel<float64,\ N>}}(pixel).mulLocal(weights[i]));}
\DoxyCodeLine{00068\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00069\ }
...
\DoxyCodeLine{00072\ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00073\ \ \ \ \ \ \ \ \ \ \ \ \ accuPixel.addLocal(0.5);}
\DoxyCodeLine{00074\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00075\ }
