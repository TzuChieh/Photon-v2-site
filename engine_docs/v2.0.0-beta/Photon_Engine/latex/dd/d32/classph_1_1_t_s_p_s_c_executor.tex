...
{\bfseries TSPSCExecutor} (std\+::function$<$ void(const Work \&work)$>$ work\+Processor)
\begin{DoxyCompactList}\small\item\em Create an executor waiting for new work. \end{DoxyCompactList}\item 
...
{\bfseries \texorpdfstring{$\sim$}{\string~}\+TSPSCExecutor} ()
...
void {\bfseries set\+On\+Consumer\+Start} (std\+::function$<$ void(void)$>$ on\+Consumer\+Start)
\item 
...
void {\bfseries set\+On\+Consumer\+Terminate} (std\+::function$<$ void(void)$>$ on\+Consumer\+Terminate)
...
\item 
Source/\+Utility/\+Concurrent/TSPSCExecutor.\+h\item 
Source/\+Utility/\+Concurrent/TSPSCExecutor.\+ipp\end{DoxyCompactItemize}
