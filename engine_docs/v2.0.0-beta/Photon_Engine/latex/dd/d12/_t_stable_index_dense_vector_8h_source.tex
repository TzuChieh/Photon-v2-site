...
\mbox{\hyperlink{_t_stable_index_dense_vector_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00080\ }
\DoxyCodeLine{00086\ \ \ \ \ \textcolor{keyword}{typename}\ std::vector<T>::iterator\ \ \ \ \ \ \ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_a874a7d59fe057c570edef8af99f513a6}{begin}}()\ noexcept;}
\DoxyCodeLine{00087\ \ \ \ \ typename\ \mbox{\hyperlink{namespacestd}{std}}::vector<T>::const\_iterator\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_a874a7d59fe057c570edef8af99f513a6}{begin}}()\ const\ noexcept;}
\DoxyCodeLine{00088\ \ \ \ \ typename\ \mbox{\hyperlink{namespacestd}{std}}::vector<T>::iterator\ \ \ \ \ \ \ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_acc2700e2c63684bfc6e934c20d510aa5}{end}}()\ \ \ noexcept;}
\DoxyCodeLine{00089\ \ \ \ \ typename\ \mbox{\hyperlink{namespacestd}{std}}::vector<T>::const\_iterator\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_acc2700e2c63684bfc6e934c20d510aa5}{end}}()\ \ \ const\ noexcept;}
\DoxyCodeLine{00091\ }
\DoxyCodeLine{00097\ \ \ \ \ T\&\ operator\ []\ (SIndex\ stableIndex);}
\DoxyCodeLine{00098\ \ \ \ \ const\ T\&\ operator\ []\ (SIndex\ stableIndex)\ const;}
\DoxyCodeLine{00100\ }
\DoxyCodeLine{00107\ \ \ \ \ T*\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_ad0fc8ca10ae316b6a3d2222d3245f36e}{get}}(SIndex\ stableIndex);}
\DoxyCodeLine{00108\ \ \ \ \ const\ T*\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_ad0fc8ca10ae316b6a3d2222d3245f36e}{get}}(SIndex\ stableIndex)\ const;}
\DoxyCodeLine{00110\ }
...
\DoxyCodeLine{00117\ }
\DoxyCodeLine{00118\ \ \ \ \ \mbox{\hyperlink{namespacestd}{std}}::vector<T>\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ m\_objects;}
\DoxyCodeLine{00119\ \ \ \ \ \mbox{\hyperlink{namespacestd}{std}}::vector<SIndex>\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ m\_objectToStableIndex;}
\DoxyCodeLine{00120\ \ \ \ \ \mbox{\hyperlink{namespacestd}{std}}::vector<\mbox{\hyperlink{namespacestd}{std}}::pair<OIndex,\ \textcolor{keywordtype}{bool}>>\ m\_stableIndexToObject;}
\DoxyCodeLine{00121\ \ \ \ \ \mbox{\hyperlink{namespacestd}{std}}::vector<SIndex>\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ m\_freeIndices;}
\DoxyCodeLine{00122\ \};}
\DoxyCodeLine{00123\ }
\DoxyCodeLine{00124\ \textcolor{comment}{//\ Implementations:}}
\DoxyCodeLine{00125\ }
\DoxyCodeLine{00126\ template<typename\ T,\ \mbox{\hyperlink{namespacestd}{std}}::integral\ SIndex>}
...
\DoxyCodeLine{00128\ }
\DoxyCodeLine{00129\ template<typename\ T,\ \mbox{\hyperlink{namespacestd}{std}}::integral\ SIndex>}
\DoxyCodeLine{00130\ inline\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector}{TStableIndexDenseVector}}<T,\ SIndex>::\mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector}{TStableIndexDenseVector}}(const\ \mbox{\hyperlink{namespacestd}{std}}::\textcolor{keywordtype}{size\_t}\ initialCapacity)\ :}
...
\DoxyCodeLine{00215\ \textcolor{keyword}{inline}\ T\&\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_aaa5ffd967f29d70ed6569d28ae024e8e}{TStableIndexDenseVector<T,\ SIndex>::operator\ []\ }}(\textcolor{keyword}{const}\ SIndex\ stableIndex)}
\DoxyCodeLine{00216\ \{}
...
\DoxyCodeLine{00224\ \textcolor{keyword}{inline}\ \textcolor{keyword}{const}\ T\&\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_aaa5ffd967f29d70ed6569d28ae024e8e}{TStableIndexDenseVector<T,\ SIndex>::operator\ []\ }}(\textcolor{keyword}{const}\ SIndex\ stableIndex)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00233\ \textcolor{keyword}{inline}\ T*\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_ad0fc8ca10ae316b6a3d2222d3245f36e}{TStableIndexDenseVector<T,\ SIndex>::get}}(\textcolor{keyword}{const}\ SIndex\ stableIndex)}
\DoxyCodeLine{00234\ \{}
\DoxyCodeLine{00235\ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_a0d38b6e4f5952719533409c6f91c2b46}{isStableIndexValid}}(stableIndex)\ ?\ \&((*this)[stableIndex])\ :\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00236\ \}}
\DoxyCodeLine{00237\ }
\DoxyCodeLine{00238\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ T,\ std::\textcolor{keywordtype}{int}egral\ SIndex>}
\DoxyCodeLine{00239\ \textcolor{keyword}{inline}\ \textcolor{keyword}{const}\ T*\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_ad0fc8ca10ae316b6a3d2222d3245f36e}{TStableIndexDenseVector<T,\ SIndex>::get}}(\textcolor{keyword}{const}\ SIndex\ stableIndex)\textcolor{keyword}{\ const}}
\DoxyCodeLine{00240\ \textcolor{keyword}{}\{}
\DoxyCodeLine{00241\ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_a0d38b6e4f5952719533409c6f91c2b46}{isStableIndexValid}}(stableIndex)\ ?\ \&((*this)[stableIndex])\ :\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00242\ \}}
\DoxyCodeLine{00243\ }
...
\DoxyCodeLine{00251\ \textcolor{keyword}{inline}\ \textcolor{keyword}{typename}\ std::vector<T>::iterator\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_a874a7d59fe057c570edef8af99f513a6}{TStableIndexDenseVector<T,\ SIndex>::begin}}()\ noexcept}
\DoxyCodeLine{00252\ \{}
...
\DoxyCodeLine{00257\ \textcolor{keyword}{inline}\ \textcolor{keyword}{typename}\ std::vector<T>::const\_iterator\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_a874a7d59fe057c570edef8af99f513a6}{TStableIndexDenseVector<T,\ SIndex>::begin}}()\ const\ noexcept}
\DoxyCodeLine{00258\ \{}
...
\DoxyCodeLine{00263\ \textcolor{keyword}{inline}\ \textcolor{keyword}{typename}\ std::vector<T>::iterator\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_acc2700e2c63684bfc6e934c20d510aa5}{TStableIndexDenseVector<T,\ SIndex>::end}}()\ noexcept}
\DoxyCodeLine{00264\ \{}
...
\DoxyCodeLine{00269\ \textcolor{keyword}{inline}\ \textcolor{keyword}{typename}\ std::vector<T>::const\_iterator\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector_acc2700e2c63684bfc6e934c20d510aa5}{TStableIndexDenseVector<T,\ SIndex>::end}}()\ const\ noexcept}
\DoxyCodeLine{00270\ \{}
...
\DoxyCodeLine{00275\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ \mbox{\hyperlink{classph_1_1_t_stable_index_dense_vector}{TStableIndexDenseVector<T,\ SIndex>::dispatchStableIndex}}()}
