...
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \ \ \ \ \mbox{\hyperlink{classph_1_1editor_1_1_t_query_ae3bad6e23639833e44848d4a837c0a88}{TQuery}}(std::shared\_ptr<Performer>\ performer,\ \mbox{\hyperlink{namespaceph_1_1editor_affec8e1f4ada8e246a346ebbf8c0b217}{EQuery}}\ mode);}
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00037\ \ \ \ \ \textcolor{keyword}{template}<CDerived<Performer>\ DerivedPerformer>}
\DoxyCodeLine{00038\ \ \ \ \ \mbox{\hyperlink{classph_1_1editor_1_1_t_query_ae3bad6e23639833e44848d4a837c0a88}{TQuery}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classph_1_1editor_1_1_t_query}{TQuery<Target,\ DerivedPerformer>}}\&\ derivedQuery);}
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00042\ \ \ \ \ \textcolor{keyword}{template}<CDerived<Performer>\ DerivedPerformer>}
\DoxyCodeLine{00043\ \ \ \ \ \mbox{\hyperlink{classph_1_1editor_1_1_t_query_ae3bad6e23639833e44848d4a837c0a88}{TQuery}}(\mbox{\hyperlink{classph_1_1editor_1_1_t_query}{TQuery<Target,\ DerivedPerformer>}}\&\&\ derivedQuery);}
\DoxyCodeLine{00044\ }
...
\DoxyCodeLine{00075\ \ \ \ \ \{}
\DoxyCodeLine{00076\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classph_1_1editor_1_1_t_query_ae3bad6e23639833e44848d4a837c0a88}{TQuery<Target,\ DerivedPerformer>}}(}
...
\DoxyCodeLine{00082\ \ \ \ \ \{}
\DoxyCodeLine{00083\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classph_1_1editor_1_1_t_query_ae3bad6e23639833e44848d4a837c0a88}{TQuery<Target,\ DerivedPerformer>}}(}
...
\DoxyCodeLine{00094\ \ \ \ \ \textcolor{keyword}{friend}\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classph_1_1editor_1_1_t_query}{TQuery}};}
\DoxyCodeLine{00095\ \};}
\DoxyCodeLine{00096\ }
\DoxyCodeLine{00097\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ Target,\ \textcolor{keyword}{typename}\ Performer>}
\DoxyCodeLine{00098\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classph_1_1editor_1_1_t_query_a7e10a2b1c989f0002aac0a9d94f22519}{TQuery<Target,\ Performer>::clear}}()}
\DoxyCodeLine{00099\ \{}
\DoxyCodeLine{00100\ \ \ \ \ m\_performer\ =\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00101\ \}}
\DoxyCodeLine{00102\ }
\DoxyCodeLine{00103\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ Target,\ \textcolor{keyword}{typename}\ Performer>}
\DoxyCodeLine{00104\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{classph_1_1editor_1_1_t_query_a1d2eaf5e2e9123471dfc3aaf83232f2e}{TQuery<Target,\ Performer>::isEmpty}}()\textcolor{keyword}{\ const}}
\DoxyCodeLine{00105\ \textcolor{keyword}{}\{}
\DoxyCodeLine{00106\ \ \ \ \ \textcolor{keywordflow}{return}\ m\_performer\ ==\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00107\ \}}
\DoxyCodeLine{00108\ }
\DoxyCodeLine{00109\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ Target,\ \textcolor{keyword}{typename}\ Performer>}
\DoxyCodeLine{00110\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ \mbox{\hyperlink{classph_1_1editor_1_1_t_query_ae2452d0725c526d7731baae0437225ce}{TQuery<Target,\ Performer>::get}}()}
\DoxyCodeLine{00111\ -\/>\ Performer\&}
\DoxyCodeLine{00112\ \{}
\DoxyCodeLine{00113\ \ \ \ \ PH\_ASSERT(m\_performer);}
\DoxyCodeLine{00114\ \ \ \ \ \textcolor{keywordflow}{return}\ *m\_performer;}
\DoxyCodeLine{00115\ \}}
\DoxyCodeLine{00116\ }
\DoxyCodeLine{00117\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ Target,\ \textcolor{keyword}{typename}\ Performer>}
\DoxyCodeLine{00118\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ \mbox{\hyperlink{classph_1_1editor_1_1_t_query_ae2452d0725c526d7731baae0437225ce}{TQuery<Target,\ Performer>::get}}()\ const}
\DoxyCodeLine{00119\ -\/>\ const\ Performer\&}
\DoxyCodeLine{00120\ \{}
\DoxyCodeLine{00121\ \ \ \ \ PH\_ASSERT(m\_performer);}
\DoxyCodeLine{00122\ \ \ \ \ \textcolor{keywordflow}{return}\ *m\_performer;}
\DoxyCodeLine{00123\ \}}
\DoxyCodeLine{00124\ }
\DoxyCodeLine{00125\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ Target,\ \textcolor{keyword}{typename}\ Performer>}
\DoxyCodeLine{00126\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ \mbox{\hyperlink{classph_1_1editor_1_1_t_query_a9acec6e725429280e84ba75d4ac5cc2e}{TQuery<Target,\ Performer>::operator\ -\/>\ }}()}
\DoxyCodeLine{00127\ -\/>\ Performer*}
\DoxyCodeLine{00128\ \{}
\DoxyCodeLine{00129\ \ \ \ \ \textcolor{keywordflow}{return}\ \&(get());}
\DoxyCodeLine{00130\ \}}
\DoxyCodeLine{00131\ }
\DoxyCodeLine{00132\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ Target,\ \textcolor{keyword}{typename}\ Performer>}
\DoxyCodeLine{00133\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ \mbox{\hyperlink{classph_1_1editor_1_1_t_query_a9acec6e725429280e84ba75d4ac5cc2e}{TQuery<Target,\ Performer>::operator\ -\/>\ }}()\ const}
\DoxyCodeLine{00134\ -\/>\ const\ Performer*}
\DoxyCodeLine{00135\ \{}
\DoxyCodeLine{00136\ \ \ \ \ \textcolor{keywordflow}{return}\ \&(get());}
\DoxyCodeLine{00137\ \}}
\DoxyCodeLine{00138\ }
\DoxyCodeLine{00139\ \}\textcolor{comment}{//\ end\ namespace\ ph::editor}}
\DoxyCodeLine{00140\ }
\DoxyCodeLine{00141\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{_t_query_8ipp}{EditorCore/Query/TQuery.ipp}}"{}}}
